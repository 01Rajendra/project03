...
public class ErrorCtl extends BaseCtl {
	...
	private String getViewFromCtl(String ctl) {
		...
		if (ctl.endsWith(ORSView.SECRET_CTL))

			return ORSView.SECRET_VIEW;
		
		if (ctl.endsWith(ORSView.PORTFOLIO_CTL))
		...
		if (ctl.endsWith(ORSView.PORTFOLIO_LIST_CTL))

			return ORSView.PORTFOLIO_LIST_VIEW;
		
		if (ctl.endsWith(ORSView.CUSTOMER_LIST_CTL))
