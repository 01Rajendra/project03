...
public class ServletUtility {
	...
	public static void handleExceptionDBDown(Exception e, HttpServletRequest request, HttpServletResponse response,
			String view) throws IOException, ServletException {

		request.setAttribute("error", "Database is down. Please try again later.");
