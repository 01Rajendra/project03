			...
			<div class="row">
				...
				<div class="col-sm-2">
					...
					<input type="text" name="orderId" placeholder="Enter Order Id"
						class="form-control"
						value="<%=ServletUtility.getParameter("orderId", request)%>">
				...
				<div class="col-sm-2">
					...
					<input type="text" name="orderDate" placeholder="Enter Order Date"
						class="form-control"
				...
				<div class="col-sm-2">
					...
					<input type="text" name="customerId"
						placeholder="Enter Customer Id" class="form-control"
						value="<%=ServletUtility.getParameter("customerId", request)%>">
				...
				<table class="table table-bordered table-dark table-hover">
					...
					<thead>
						...
						<tr style="background-color: red;">
							...
							<th width="15%" class="text">Order Id</th>

							<th width="20%" class="text">Order Date</th>

							<th width="15%" class="text">Status</th>

							<th width="15%" class="text">Customer Id</th>
					...
					<tbody>
						...
						<tr>
							...
							<td align="center"><input type="checkbox" class="checkbox"
								name="ids" value="<%=dto.getOrderId()%>"></td>


							<td class="text"><%=index++%></td>


							<td class="text"><%=dto.getOrderId()%></td>
							...
							<td class="text"><a
								href="<%=ORSView.ORDER_CTL%>?orderId=<%=dto.getOrderId()%>">
									Edit </a></td>
